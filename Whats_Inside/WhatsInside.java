...
public class Main {
    public static void main(String[] args) {
         ...
         * Create an array of Strings(String[] animals = {String block of code for each animal})
         * Print the prompt "Please enter the number of the habitat you would like to view: "
         * Accept user input nextInt() from the Scanner object
         * Print the data saved in the array at the index of the user input.
         * End the text block with the following phrase:
         * ---
